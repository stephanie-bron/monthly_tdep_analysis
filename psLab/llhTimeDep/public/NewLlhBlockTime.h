...
class NewLlhBlockTime : public AnalysisFn {
 ...
 public:
  ...
  friend class NewLlhBlockTimeFCN;
  ...
  void SetTimeBounds(double tmin, double tmax) {
    tmin_ = tmin;
    tmax_ = tmax;
    cout << "Time bounds : " << tmin << " " << tmax << endl;
  }
...
class NewLlhBlockTimeFCN : public ROOT::Minuit2::FCNBase {
 private:
  NewLlhBlockTime* ptr;
 ...
 public:
  ...
  virtual void Point(AnalysisFn* fn) {
    ptr = dynamic_cast<NewLlhBlockTime*>(fn); 
  }
};
