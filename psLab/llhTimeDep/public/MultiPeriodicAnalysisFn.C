...
double MultiPeriodicAnalysisFCN::operator() (const vector<double>& parVect) const {
  double result = 0.;
...
MultiPeriodicAnalysisFn::MultiPeriodicAnalysisFn() {
  fcn_ = new MultiPeriodicAnalysisFCN();
  fcn_->Point(this);
...
//  double g[ngamma] = {2.0};
  ...
  int n[] =  {tVectorclose.size()/66,
              tVectorclose.size()/50, tVectorclose.size()/33,
              tVectorclose.size()/25, tVectorclose.size()/20,
              tVectorclose.size()/10, tVectorclose.size()/7,
              tVectorclose.size()/5,  tVectorclose.size()/4,
              tVectorclose.size()/3,  tVectorclose.size()/2};
