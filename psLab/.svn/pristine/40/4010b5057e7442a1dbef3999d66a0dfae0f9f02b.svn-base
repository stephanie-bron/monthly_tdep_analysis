...
TCanvas* MultiDetectionStudy(Ark& ark, MultiAnalysisFn& llh, MultiAnalysisSet * mas, DiscoveryPotential& disco) {
...
double MultiDetectionStudy_d(Ark& ark, MultiAnalysisFn& llh, MultiAnalysisSet * mas, DiscoveryPotential& disco)
{
