...
void load_ark_ic86_BDT_tdep_at(I3Ark& ark, bool opt_UseRealData, TString RecoName) {
...
if (opt_UseRealData) {   
   ...
   psData->SetRandomizeBase(true);
   ic86Itimes->SetTimesFromMJDFile("/atlas/users/christov/psLab/macro_llh/IC86-IV_TDep/HugeListOf_IC86-I_TimesNewMethod.txt");
   psData->SetEventTimeModulePtr(ic86Itimes);
