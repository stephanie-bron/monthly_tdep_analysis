...
void load_ark_ic86_II_III_IV_tdep_lc(I3Ark& ark, bool opt_UseRealData, TString RecoName) {
...
//   cout << "Using cut: " << ark.evLoader.GetCuts().GetTitle() << endl;
  ...
  if (opt_UseRealData) {
    ...
    icIC86II_to_IV_times->SetTimesFromMJDFile("/home/christov/psLab/macro_llh/IC86-IV_TDep/HugeListOfICII_to_IV_TimesNewMethod.txt");
