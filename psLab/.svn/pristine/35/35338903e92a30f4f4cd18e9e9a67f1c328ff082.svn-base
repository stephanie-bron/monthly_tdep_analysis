...
void load_ark_ic79_Sirin(I3Ark& ark, bool opt_UseRealData) {
  cout << "\n-----  LOADING IC-79 BDT  -----\n";
  ...
  ark.evLoader.SetBkgTree( LoadTree_IC79_GoodRuns_Sirin_small() );
  ...
  ark.evLoader.SetSourceTree( LoadTree_IC79_nugen_numu_6308_Sirin_small() );
  ...
  //  ark.evLoader.SetName_sigmaDeg("mpfSigmaDegRescaledIC79Sirin(mpbSigmaDeg,NChan)");
  ark.evLoader.SetName_sigmaDeg("RescaledSigma_IC79(mpbSigmaDeg,NChan)");
