...
void load_ark_ic59_BDT_tdep_lc(I3Ark& ark, bool opt_UseRealData) {
  cout << "\n-----  LOADING IC-59 BDT  -----\n";
  ...
  */
  ...
  if (opt_UseRealData) {
    ...
    ic59times->SetTimesFromMJDFile("/home/christov/psLab/macro_llh/IC86-II-III_TDep/HugeListOfIC59TimesNewMethod.txt");
    psData->SetEventTimeModulePtr(ic59times);
