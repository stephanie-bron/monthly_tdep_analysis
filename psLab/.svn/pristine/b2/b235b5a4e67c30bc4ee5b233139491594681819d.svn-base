TString LOADTREE_86DIR = "/net/user/jfeintzeig/2012/PointSources/";


TTree* LoadTree_IC86_nugen_numu_joint() {
  TString upfilesnugen = LOADTREE_86DIR + "FinalFiles/MonteCarlo/PrunedNugenUpgoing4866.root";
  TString downfilesnugen = LOADTREE_86DIR + "FinalFiles/MonteCarlo/PrunedNugenDowngoing4866.root";
...
TTree* LoadTree_IC86_GoodRuns_Burn() {
  ...
  TString livetimeTotalStr = " HitMultiplicityValues.n_hit_doms/HitMultiplicityValues.n_hit_doms * 2728913.2"; // livetime in sec
  TString tmin = " HitMultiplicityValues.n_hit_doms/HitMultiplicityValues.n_hit_doms * 55695.661898"; //in MJD
  TString tmax = " HitMultiplicityValues.n_hit_doms/HitMultiplicityValues.n_hit_doms * 56061.487604";
...
TTree* LoadTree_IC86_GoodRuns_Full() {
  ...
  //TString upfiles = "/net/user/achristov/FixedPS_IC86-I_sample/PrunedDataUpgoing_fixed.root";
  TString upfiles = LOADTREE_86DIR+"FinalFiles/Data/PrunedDataUpgoing_fixed.root";
  TString downfiles = LOADTREE_86DIR+"FinalFiles/Data/PrunedDataDowngoing.root";
  ...
  TString livetimeTotalStr = " HitMultiplicityValues.n_hit_doms/HitMultiplicityValues.n_hit_doms * 28737504.0"; // livetime in sec
  TString tmin = " HitMultiplicityValues.n_hit_doms/HitMultiplicityValues.n_hit_doms * 55694.99085730"; //in MJD
  TString tmax = " HitMultiplicityValues.n_hit_doms/HitMultiplicityValues.n_hit_doms * 56062.41792913";
