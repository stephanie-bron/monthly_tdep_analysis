...
void loadSplines_IC86_II_III_IV_SplineMPE(){
    TFile *fup=new TFile("$LAB_MAIN_DIR/macro_llh/IC86-IV_TDep/SplineMPEPullCorrectionIC86_II_III_IV_upgoing.root");
    upspline=(TSpline5*)fup->Get("Spline5");
    fup->Close();
    TFile *fdown=new TFile("$LAB_MAIN_DIR/macro_llh/IC86-IV_TDep/SplineMPEPullCorrectionIC86_II_III_IV_downgoing.root");
