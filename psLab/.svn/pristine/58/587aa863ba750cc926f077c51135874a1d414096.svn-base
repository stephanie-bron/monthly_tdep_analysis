void load_ark_IC86_II_to_IV_MESE_tdep_lc_folded(I3Ark& ark, bool opt_UseRealData, TString RecoName, double NbinsZen=12., double NbinsAz=90.) {
    ...
    cout << "Reloaded MESE tree, taking only IC86II to IV" << endl;
