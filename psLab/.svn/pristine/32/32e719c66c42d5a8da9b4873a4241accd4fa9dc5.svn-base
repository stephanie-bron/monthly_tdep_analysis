...
void load_ark_IC79_86_I_to_IV_MESE(I3Ark& ark, bool opt_UseRealData, TString RecoName) {
...
//ark.evLoader.SetSourceZenWidthDegRange(0.5, 80., 90.);
  ...
  TCut MESE_Cut =  ICMESE_Cuta&&ICMESE_Cutb&&ICMESE_Cutc;//"MESECut.Pass==1";
  ...
  if (RecoName.CompareTo("MPEFit_TT")==0) {
    ...
    cout << "Rescaling ung MuEXAngular4...\n";
...
//   cout << "Using cut: " << ark.evLoader.GetCuts().GetTitle() << endl;
  ...
  // 1. deg smoothing and 45 declination maps (e.g. 1 deg binning)
...
if (opt_UseRealData) {   
 ...
 cout << "----- IC79  and IC86 1 to 4  Loaded -----\n";
